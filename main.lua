    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://15935059060" then
                    return v
                end
            end
        end
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://15935059060"
...
Tabs.Misc:AddButton({
	...
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://15935059060")[1]:GetChildren()) do
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://15935059060"
...
----------------------------------------------------------------------------------------------------------------------------------------------
InterfaceManager:SetFolder("JackScriptHub")
SaveManager:SetFolder("JackScriptHub/specific-game")
Window:SelectTab(1)
Fluent:Notify({
    Title = "Jack Hub",
